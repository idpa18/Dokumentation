\begin{titlepage} % Suppresses displaying the page number on the title page and the subsequent page counts as page 1
	...
	\textsc{\large oder "Was unsere Grossväter im Keller taten"}\\[0.5cm] % Minor heading such as course title
	...
	{\large IDPA an der BBBaden} % Date, change the \today to a set date if you want to be precise
